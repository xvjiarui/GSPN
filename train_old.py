...
parser.add_argument('--max_epoch', type=int, default=7, help='Epoch to run [default: 400]')
...
parser.add_argument('--decay_step', type=int, default=1250, help='Decay step for lr decay [default: 200000]')
